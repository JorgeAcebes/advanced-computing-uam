...
\begin{center}
{\vspace{2cm}
\textbf{\huge\ Práctica 4: La Firma del Caos}}\\
\vspace{10pt}
\large
Jorge Acebes Hernández\hfill Computación Avanzada\hfill \href{https://github.com/JorgeAcebes/advanced-computing-uam/tree/main/src/4}{Código - GitHub}
\end{center}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
