...
\begin{center}
{\vspace{2cm}
\textbf{\huge\ Práctica 5: Cometa Halley y Puntos de Lagrange}}\\
\vspace{10pt}
\large
Jorge Acebes Hernández\hfill Computación Avanzada\hfill \href{https://github.com/JorgeAcebes/advanced-computing-uam/tree/main/src/5}{Código - GitHub}
\end{center}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
