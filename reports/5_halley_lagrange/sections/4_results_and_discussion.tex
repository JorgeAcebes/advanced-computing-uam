...
\begin{figure}[htbp]
    \centering
    \href{https://youtu.be/lc274xHxq8g}{\includegraphics[width=0.9\textwidth]{figures_tex/halley_sun.png}}
    \caption{Trayectoria orbital 2D del Cometa Halley (púrpura) en el plano orbital, con el Sol (estrella amarilla) ubicado en uno de los focos de la elipse. Animación accesible en \href{https://youtu.be/lc274xHxq8g}{YouTube}.}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{figures_tex/energy_momentum.png}
...
Para determinar la precesión del perihelio ($\dot{\omega}$) del cometa Halley bajo la perturbación de Júpiter, se analizó la respuesta del sistema escalando paramétricamente la masa joviana ($M_J$). La Figura \ref{fig:why_extrapolation} muestra que, para ciertos valores de masas, se producen cambios de precesión abruptos, y en inspección más profunda, se observa que para masas inferiores a $5M_J$ la señal de precesión no es confiable. En consecuencia, se realizó una un filtrado de $1\sigma$ en los datos en el intervalo $[5M_J, 40M_J]$, y posteriormente una extrapolación lineal hacia el valor real de la masa ($1M_J$). El resultado se muestra en la Figura \ref{fig:extrapolation}, obteniendo una tasa de precesión:$$\dot{\omega} = -4.6 \times 10^{-5} \, \text{rad/año}$$ 
...
\begin{figure}[htbp]
    ...
    \begin{minipage}{0.48\textwidth}
        ...
        \caption{Variación de la tasa de precesión para factores de masa de Júpiter y su ajuste lineal.}
        \label{fig:why_extrapolation}
    \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth}
        \includegraphics[width=\textwidth]{figures_tex/extrapolation.png}
        \caption{Variación de la tasa de precesión para factores de masa de Júpiter con fitro $1\sigma$ y su ajuste lineal.}
...
\begin{figure}[htbp]
    \centering
    \begin{minipage}{0.48\textwidth}
    \href{https://www.youtube.com/watch/RlNEgH9QZA4?feature=share}{\includegraphics[width=\textwidth]{figures_tex/orbit_lagrange_L1.png}}
    \end{minipage}
    \begin{minipage}{0.48\textwidth}
        \href{https://www.youtube.com/watch?v=51BHZS_yqqw}{\includegraphics[width=\textwidth]{figures_tex/orbit_lagrange_L2.png}}
    \end{minipage}
    \begin{minipage}{0.48\textwidth}
        \href{https://www.youtube.com/watch?v=1oSx0j2YHP0}{\includegraphics[width=\textwidth]{figures_tex/orbit_lagrange_L3.png}}
    \end{minipage}
    \begin{minipage}{0.48\textwidth}
        \href{https://youtube.com/watch/4zm1RVNYcHc?feature=share}{\includegraphics[width=\textwidth]{figures_tex/orbit_lagrange_L4.png}}
    \end{minipage}
...
En los puntos colineales ($L_1, L_2, L_3$), las variaciones iniciales $\delta_i$ provocan una divergencia rápida, llevando a las masas de prueba a trayectorias de escape erráticas. En $L_4$, la masa de prueba permanece confinada, trazando órbitas complejas acotadas. Se puede acceder a las trayectorias animadas en \href{https://www.youtube.com/watch?v=RlNEgH9QZA4&list=TLGG684h-9BVPRkxMzAzMjAyNg}{YouTube}.
