...
\begin{itemize}
    ...
    \item \textbf{Eficacia de la extrapolación paramétrica:} Ante la presencia de fluctuaciones numéricas para masas bajas así como fenómenos de resonancia para masas particulares, el uso de una extrapolación lineal desde el régimen $[5 M_J, 40 M_J]$ con un filtrado de $1 \sigma$ se revela como una estrategia computacionalmente eficiente. Este método permite aislar la tendencia de la precesión de manera precisa. Con esto, se obtiene una precesión para la masa real de Júpiter de $\dot{\omega} = -4.6 \times 10^{-5} \, \text{rad/año}$.
