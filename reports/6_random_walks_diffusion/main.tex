...
\begin{center}
{\vspace{2cm}
\textbf{\huge\ Práctica 6: Paseos Aleatorios y Difusión}}\\
\vspace{10pt}
\large
Jorge Acebes Hernández\hfill Computación Avanzada\hfill \href{https://github.com/JorgeAcebes/advanced-computing-uam/tree/main/src/6}{Código - GitHub}
\end{center}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
