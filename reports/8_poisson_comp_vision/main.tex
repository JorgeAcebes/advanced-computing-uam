...
\begin{center}
{\vspace{2cm}
\textbf{\huge\ Práctica 8: Ecuación de Poisson y Visión Artificial}}\\
\vspace{10pt}
\large
Jorge Acebes Hernández\hfill Computación Avanzada\hfill \href{https://github.com/JorgeAcebes/advanced-computing-uam/tree/main/src/8}{Código - GitHub}
\end{center}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\input{sections/1_intro}
\input{sections/2_theory}
\input{sections/3_code_and_methods}
\input{sections/4_results_and_discussion}
